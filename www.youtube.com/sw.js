...
ytcfg.set({
    ...
    "INNERTUBE_CLIENT_VERSION": "2.20221024.10.00",
    "INNERTUBE_CONTEXT": {
        "client": {
            "clientName": "WEB",
    ...
    "INNERTUBE_CONTEXT_CLIENT_VERSION": "2.20221024.10.00",
...
if (self.trustedTypes && self.trustedTypes.createPolicy) {
    const swPolicy = trustedTypes.createPolicy('youtubeServiceWorkerPolicy', {
        createScriptURL: function(ignored) {
            return 'https:\/\/www.youtube.com\/s\/desktop\/98b05ec2\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js';
        }
    });
    importScripts(swPolicy.createScriptURL(''));
} else {
    importScripts('https:\/\/www.youtube.com\/s\/desktop\/98b05ec2\/jsbin\/serviceworker-kevlar-appshell.vflset\/serviceworker-kevlar-appshell.js');
}